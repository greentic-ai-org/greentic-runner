  ...
  pub mod greentic {
    pub mod attestation {
      ...
      pub mod attester_api {
        ...
        impl ::core::fmt::Debug for AttestationId {
          fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_struct("AttestationId").field("id", &self.id).field("extra", &self.extra).finish()
          }
        }
        ...
        impl ::core::fmt::Debug for PredicateType {
          fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_struct("PredicateType").field("kind", &self.kind).field("extra", &self.extra).finish()
          }
        }
        ...
        impl ::core::fmt::Debug for StatementRef {
          fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_struct("StatementRef").field("uri", &self.uri).field("digest", &self.digest).field("extra", &self.extra).finish()
          }
        }
        ...
        impl ::core::fmt::Debug for SubjectRef {
          fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_struct("SubjectRef").field("id", &self.id).field("extra", &self.extra).finish()
          }
        }
        #[doc(hidden)]
        #[allow(non_snake_case, unused_unsafe)]
        pub unsafe fn _export_generate_attestation_cabi<T: Guest>(arg0: *mut u8,) -> *mut u8 { unsafe {#[cfg(target_arch="wasm32")]
        _rt::run_ctors_once();let result102 = {
          ...
          let l90 = i32::from(*arg0.add(16+60*::core::mem::size_of::<*const u8>()).cast::<u8>());
          let l94 = i32::from(*arg0.add(16+63*::core::mem::size_of::<*const u8>()).cast::<u8>());
          let l98 = i32::from(*arg0.add(16+66*::core::mem::size_of::<*const u8>()).cast::<u8>());
          T::generate_attestation(super::super::super::super::greentic::interfaces_types::types::TenantCtx{
            ...
            digest: match l90 {
              ...
              1 => {
                let e = {
                  let l91 = *arg0.add(16+61*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                  let l92 = *arg0.add(16+62*::core::mem::size_of::<*const u8>()).cast::<usize>();
                  let len93 = l92;
            ...
            extra: match l94 {
              ...
              1 => {
                let e = {
                  let l95 = *arg0.add(16+64*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                  let l96 = *arg0.add(16+65*::core::mem::size_of::<*const u8>()).cast::<usize>();
                  let len97 = l96;
            ...
            1 => {
              let e = {
                let l99 = *arg0.add(16+67*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l100 = *arg0.add(16+68*::core::mem::size_of::<*const u8>()).cast::<usize>();
                let len101 = l100;
        ...
        _rt::cabi_dealloc(arg0, 24+68*::core::mem::size_of::<*const u8>(), 8);
        let ptr103 = (&raw mut _RET_AREA.0).cast::<u8>();
        match result102 {
          Ok(e) => { {
            *ptr103.add(0).cast::<u8>() = (0i32) as u8;
            let AttestationId{ id:id104, extra:extra104, } = e;
            let vec105 = (id104.into_bytes()).into_boxed_slice();
            let ptr105 = vec105.as_ptr().cast::<u8>();
            let len105 = vec105.len();
            ::core::mem::forget(vec105);
            *ptr103.add(2*::core::mem::size_of::<*const u8>()).cast::<usize>() = len105;
            *ptr103.add(::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr105.cast_mut();
            match extra104 {
              Some(e) => {
                *ptr103.add(3*::core::mem::size_of::<*const u8>()).cast::<u8>() = (1i32) as u8;
                let vec106 = (e.into_bytes()).into_boxed_slice();
                let ptr106 = vec106.as_ptr().cast::<u8>();
                let len106 = vec106.len();
                ::core::mem::forget(vec106);
                *ptr103.add(5*::core::mem::size_of::<*const u8>()).cast::<usize>() = len106;
                *ptr103.add(4*::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr106.cast_mut();
              },
              None => {
                {
                  *ptr103.add(3*::core::mem::size_of::<*const u8>()).cast::<u8>() = (0i32) as u8;
                }
              },
            };} },
            Err(e) => { {
              *ptr103.add(0).cast::<u8>() = (1i32) as u8;
              let HostError{ code:code107, message:message107, } = e;
              let vec108 = (code107.into_bytes()).into_boxed_slice();
              let ptr108 = vec108.as_ptr().cast::<u8>();
              let len108 = vec108.len();
              ::core::mem::forget(vec108);
              *ptr103.add(2*::core::mem::size_of::<*const u8>()).cast::<usize>() = len108;
              *ptr103.add(::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr108.cast_mut();
              let vec109 = (message107.into_bytes()).into_boxed_slice();
              let ptr109 = vec109.as_ptr().cast::<u8>();
              let len109 = vec109.len();
              ::core::mem::forget(vec109);
              *ptr103.add(4*::core::mem::size_of::<*const u8>()).cast::<usize>() = len109;
              *ptr103.add(3*::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr109.cast_mut();
            } },
          };ptr103
        } }
        #[doc(hidden)]
        #[allow(non_snake_case)]
        pub unsafe fn __post_return_generate_attestation<T: Guest>(arg0: *mut u8,) { unsafe {
          ...
          match l0 {
            ...
            _ => {
              ...
              let l8 = *arg0.add(3*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
              let l9 = *arg0.add(4*::core::mem::size_of::<*const u8>()).cast::<usize>();
        ...
        pub trait Guest {
          ...
          fn generate_attestation(ctx: TenantCtx,subject: SubjectRef,predicate: PredicateType,statement: StatementRef,extra: Option<_rt::String>,) -> Result<AttestationId,HostError>;
        }
        #[doc(hidden)]

        macro_rules! __export_greentic_attestation_attester_api_1_0_0_cabi{
          ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

            #[unsafe(export_name = "greentic:attestation/attester-api@1.0.0#generate-attestation")]
            unsafe extern "C" fn export_generate_attestation(arg0: *mut u8,) -> *mut u8 {
              unsafe { $($path_to_types)*::_export_generate_attestation_cabi::<$ty>(arg0) }
            }
            #[unsafe(export_name = "cabi_post_greentic:attestation/attester-api@1.0.0#generate-attestation")]
            unsafe extern "C" fn _post_return_generate_attestation(arg0: *mut u8,) {
              unsafe { $($path_to_types)*::__post_return_generate_attestation::<$ty>(arg0) }
            }
          };);
        }
        #[doc(hidden)]
        pub(crate) use __export_greentic_attestation_attester_api_1_0_0_cabi;
...
macro_rules! __export_attester_impl {
  ($ty:ident) => (self::export!($ty with_types_in self););
  ($ty:ident with_types_in $($path_to_types_root:tt)*) => (
  $($path_to_types_root)*::exports::greentic::attestation::attester_api::__export_greentic_attestation_attester_api_1_0_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::greentic::attestation::attester_api);
  )
}
#[doc(inline)]
pub(crate) use __export_attester_impl as export;

#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.47.0:greentic:attestation@1.0.0:attester:encoded world")]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1668] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x85\x0c\x01A\x02\x01\
...
ges\x04\0\x0ahost-error\x03\0\x02\x01ks\x01r\x02\x02ids\x05extra\x04\x04\0\x0eat\
testation-id\x03\0\x05\x01r\x02\x04kinds\x05extra\x04\x04\0\x0epredicate-type\x03\
\0\x07\x01r\x03\x03uris\x06digest\x04\x05extra\x04\x04\0\x0dstatement-ref\x03\0\x09\
\x01r\x02\x02ids\x05extra\x04\x04\0\x0bsubject-ref\x03\0\x0b\x01j\x01\x06\x01\x03\
\x01@\x05\x03ctx\x01\x07subject\x0c\x09predicate\x08\x09statement\x0a\x05extra\x04\
\0\x0d\x04\0\x14generate-attestation\x01\x0e\x04\0'greentic:attestation/attester\
-api@1.0.0\x05\x02\x04\0#greentic:attestation/attester@1.0.0\x04\0\x0b\x0e\x01\0\
\x08attester\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x07\
