...
pub mod greentic {
  ...
  macro_rules! __export_message_to_event_bridge_impl {
  ...
  #[doc(inline)]
  pub(crate) use __export_message_to_event_bridge_impl as export;

  #[cfg(target_arch = "wasm32")]
  #[unsafe(link_section = "component-type:wit-bindgen:0.47.0:greentic:events-bridge@1.0.0:message-to-event-bridge:encoded world")]
  #[doc(hidden)]
...
.0\x05\x06\x04\04greentic:events-bridge/message-to-event-bridge@1.0.0\x04\0\x0b\x1d\
\x01\0\x17message-to-event-bridge\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\
