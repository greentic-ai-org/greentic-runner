...
pub mod exports {
  pub mod greentic {
    pub mod oci {
      ...
      pub mod oci_api {
        ...
        pub struct RegistryRef {
          pub registry: _rt::String,
          pub extra: Option<_rt::String>,
        }
        impl ::core::fmt::Debug for RegistryRef {
          fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_struct("RegistryRef").field("registry", &self.registry).field("extra", &self.extra).finish()
          }
        }
        /// OCI image reference.
        #[derive(Clone)]
        pub struct OciImageRef {
          pub reference: _rt::String,
          pub digest: Option<_rt::String>,
          pub tag: Option<_rt::String>,
          pub extra: Option<_rt::String>,
        }
        impl ::core::fmt::Debug for OciImageRef {
          fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_struct("OciImageRef").field("reference", &self.reference).field("digest", &self.digest).field("tag", &self.tag).field("extra", &self.extra).finish()
          }
        }
        ...
        pub unsafe fn _export_push_cabi<T: Guest>(arg0: *mut u8,) -> *mut u8 { unsafe {#[cfg(target_arch="wasm32")]
        _rt::run_ctors_once();let result95 = {
          ...
          T::push(super::super::super::super::greentic::interfaces_types::types::TenantCtx{
            ...
            reference: _rt::string_lift(bytes75),
            digest: match l76 {
              0 => None,
              1 => {
                let e = {
            ...
            registry: _rt::string_lift(bytes90),
            extra: match l91 {
              0 => None,
              1 => {
                let e = {
        ...
        match result95 {
          Ok(e) => { {
            ...
            *ptr96.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (e.clone() as i32) as u8;
          } },
          Err(e) => { {
            *ptr96.add(0).cast::<u8>() = (1i32) as u8;
            let HostError{ code:code97, message:message97, } = e;
            ...
            *ptr96.add(4*::core::mem::size_of::<*const u8>()).cast::<usize>() = len99;
            *ptr96.add(3*::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr99.cast_mut();
          } },
        };ptr96
      } }
      #[doc(hidden)]
      #[allow(non_snake_case)]
      pub unsafe fn __post_return_push<T: Guest>(arg0: *mut u8,) { unsafe {
      ...
      #[doc(hidden)]
      #[allow(non_snake_case, unused_unsafe)]
      pub unsafe fn _export_get_pull_reference_cabi<T: Guest>(arg0: *mut u8,) -> *mut u8 { unsafe {#[cfg(target_arch="wasm32")]
      _rt::run_ctors_once();let result95 = {
        let l0 = *arg0.add(0).cast::<*mut u8>();
        let l1 = *arg0.add(::core::mem::size_of::<*const u8>()).cast::<usize>();
        let len2 = l1;
        ...
        let bytes90 = _rt::Vec::from_raw_parts(l88.cast(), len90, len90);
        let l91 = i32::from(*arg0.add(16+61*::core::mem::size_of::<*const u8>()).cast::<u8>());
        T::get_pull_reference(super::super::super::super::greentic::interfaces_types::types::TenantCtx{
          env: _rt::string_lift(bytes2),
          tenant: _rt::string_lift(bytes5),
          tenant_id: _rt::string_lift(bytes8),
          team: match l9 {
      ...
      match result95 {
        Ok(e) => { {
          ...
          *ptr96.add(2*::core::mem::size_of::<*const u8>()).cast::<usize>() = len97;
          *ptr96.add(::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr97.cast_mut();
        } },
        Err(e) => { {
          *ptr96.add(0).cast::<u8>() = (1i32) as u8;
          let HostError{ code:code98, message:message98, } = e;
          let vec99 = (code98.into_bytes()).into_boxed_slice();
          let ptr99 = vec99.as_ptr().cast::<u8>();
          let len99 = vec99.len();
          ::core::mem::forget(vec99);
          *ptr96.add(2*::core::mem::size_of::<*const u8>()).cast::<usize>() = len99;
          *ptr96.add(::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr99.cast_mut();
          let vec100 = (message98.into_bytes()).into_boxed_slice();
          let ptr100 = vec100.as_ptr().cast::<u8>();
          let len100 = vec100.len();
          ::core::mem::forget(vec100);
          *ptr96.add(4*::core::mem::size_of::<*const u8>()).cast::<usize>() = len100;
          *ptr96.add(3*::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr100.cast_mut();
        } },
      };ptr96
    } }
    #[doc(hidden)]
    #[allow(non_snake_case)]
    pub unsafe fn __post_return_get_pull_reference<T: Guest>(arg0: *mut u8,) { unsafe {
      let l0 = i32::from(*arg0.add(0).cast::<u8>());
      match l0 {
        0 => {
          let l1 = *arg0.add(::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
    ...
    pub trait Guest {
      ...
      fn push(ctx: TenantCtx,image: OciImageRef,registry: RegistryRef,) -> Result<OpAck,HostError>;
      #[allow(async_fn_in_trait)]
      fn get_pull_reference(ctx: TenantCtx,image: OciImageRef,registry: RegistryRef,) -> Result<_rt::String,HostError>;
    }
    #[doc(hidden)]

    macro_rules! __export_greentic_oci_oci_api_1_0_0_cabi{
      ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

        #[unsafe(export_name = "greentic:oci/oci-api@1.0.0#push")]
        unsafe extern "C" fn export_push(arg0: *mut u8,) -> *mut u8 {
          unsafe { $($path_to_types)*::_export_push_cabi::<$ty>(arg0) }
        }
        #[unsafe(export_name = "cabi_post_greentic:oci/oci-api@1.0.0#push")]
        unsafe extern "C" fn _post_return_push(arg0: *mut u8,) {
          unsafe { $($path_to_types)*::__post_return_push::<$ty>(arg0) }
        }
        #[unsafe(export_name = "greentic:oci/oci-api@1.0.0#get-pull-reference")]
        unsafe extern "C" fn export_get_pull_reference(arg0: *mut u8,) -> *mut u8 {
          unsafe { $($path_to_types)*::_export_get_pull_reference_cabi::<$ty>(arg0) }
        }
        #[unsafe(export_name = "cabi_post_greentic:oci/oci-api@1.0.0#get-pull-reference")]
        unsafe extern "C" fn _post_return_get_pull_reference(arg0: *mut u8,) {
          unsafe { $($path_to_types)*::__post_return_get_pull_reference::<$ty>(arg0) }
        }
      };);
    }
    #[doc(hidden)]
    pub(crate) use __export_greentic_oci_oci_api_1_0_0_cabi;
...
macro_rules! __export_oci_distribution_impl {
  ($ty:ident) => (self::export!($ty with_types_in self););
  ($ty:ident with_types_in $($path_to_types_root:tt)*) => (
  $($path_to_types_root)*::exports::greentic::oci::oci_api::__export_greentic_oci_oci_api_1_0_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::greentic::oci::oci_api);
  )
}
#[doc(inline)]
pub(crate) use __export_oci_distribution_impl as export;

#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.47.0:greentic:oci@1.0.0:oci-distribution:encoded world")]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1648] = *b"\
...
ges\x04\0\x0ahost-error\x03\0\x02\x01ks\x01r\x02\x08registrys\x05extra\x04\x04\0\
\x0cregistry-ref\x03\0\x05\x01r\x04\x09references\x06digest\x04\x03tag\x04\x05ex\
tra\x04\x04\0\x0doci-image-ref\x03\0\x07\x01m\x01\x02ok\x04\0\x06op-ack\x03\0\x09\
\x01j\x01\x0a\x01\x03\x01@\x03\x03ctx\x01\x05image\x08\x08registry\x06\0\x0b\x04\
\0\x04push\x01\x0c\x01j\x01s\x01\x03\x01@\x03\x03ctx\x01\x05image\x08\x08registr\
y\x06\0\x0d\x04\0\x12get-pull-reference\x01\x0e\x04\0\x1agreentic:oci/oci-api@1.\
0.0\x05\x02\x04\0#greentic:oci/oci-distribution@1.0.0\x04\0\x0b\x16\x01\0\x10oci\
